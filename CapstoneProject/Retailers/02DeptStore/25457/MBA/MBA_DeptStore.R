...
setwd("~/Google Drive/GreatLakes Capstone Project/Retailers/02DeptStore/25457/MBA/")
...
#Extended rules
ext_rules <- apriori(txn, parameter = list(supp = 0.0001, conf = 0.1,minlen=3))
length(ext_rules)
...
# Get the rules
basket_rules <- apriori(txn, parameter = list(supp = 0.0003, conf = 0.8,minlen=3))
length(basket_rules)
