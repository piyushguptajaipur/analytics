...
setwd("~/Google Drive/GreatLakes Capstone Project/Retailers/05QuickServiceRestaurants/MBA/")
...
pdt_name_new
write.table(pdt_name_new, file = "QSR_Products.csv",row.names=FALSE, na="",col.names=c(""), sep=",")
