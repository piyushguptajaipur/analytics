...
#InvalidBuyers<-NULL
InvalidBuyers <- c("FERN", "FNP", "CASH", "WALK", "ECOM")
...
InvoiceRFMScore <- GetCumScore(InvoiceRFMScore, , ,c(25,35,40))
...
RFM_Segements <- read.xlsx("RFM_Segements.xlsx",sheetIndex=1)
RFM_Segements$Score <- 100*RFM_Segements$R+10*RFM_Segements$F+RFM_Segements$M
